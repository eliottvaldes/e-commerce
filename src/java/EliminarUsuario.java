    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                if(v.validarStock(id)==true){
                    ...
                    rs = set.executeQuery("select * from usuario where user_usr = '"+user_usr+"'");
                        ...
                        if(match == false){
                            ...
                            if(existe == false || isAdmin==false){
                                message ="<h2>El numero de lista no es valido o pertenece a un cliente</h2>";
                            }else{
                                String q = "delete from usuario where id_usr = "+id_usr+";\n";
                                     if(set.executeUpdate(q)==1){
                                         message = "<h2 class=\"tm-block-title mt-3\">Se elimino la cuenta</h2>\n";
                                }
                            }
                ...
                System.out.println(e.getMessage());
                System.out.println(e.getStackTrace());
                message ="<h2>No puedes eliminar clientes</h2>";
            }
