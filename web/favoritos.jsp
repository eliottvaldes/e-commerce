        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading clearfix"><br>
                        ...
                        <a class="h4"><i class="fa fa-heart"></i> Favoritos </a>
            ...
            <% //vamos a conectar con la DB
                ...
                try {
                    ...
                    String g = "select distinct id_art, nom_art, des_art, prc_art, img_art from carrito.articulo, carrito.favoritos where id_art=id_articulo and id_usuario=" + para + "";
                    rs2 = st2.executeQuery(g);

                    //para ocultar tabla si no hay favoritos 
                    st3 = con2.createStatement();
                    String q3 = "SELECT COUNT(id_articulo) FROM carrito.favoritos WHERE id_usuario =" + para + "";
            ...
            <div <%=hidemsg%> class="text-muted text-center">
                <br>
                <h1>No tienes productos marcados como favoritos</h1>
                <br>
                <div>
                    <i class="fa fa-heart-o " style="font-size: 300px;"></i>
                </div><br>
                ...
                <table <%=hidetable%> class="table table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <td  class="align-middle" scope="row">
                            <img src=<%=rs2.getString(5)%> alt=<%="Product" + rs2.getString(5)%> width="90%">
                        </td>                        
                    ...
                    <%
                        System.out.println("valor i es: " + i);
