        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="tm-col tm-col-big" style="width: 60%; text-align: center;">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title">Ingresa el numero de lista del articulo y los nuevos datos, puedes mantener los mismos, solo repitelos en los campos</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <form action="ModificarArticulo" method="post" class="tm-login-form">
                                ...
                                <br>
                                    <div class="input-group">
                                        <label for="price" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Precio ($): </label>
                                        <input placeholder="1" id="price" name="price" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" required>
                                    </div>
                                <br>
                                    <div class="input-group">
                                        <label for="stock" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Cantidad: </label>
                                        <input placeholder="0" id="stock" name="stock" type="text" class="form-control validate col-xl-9 col-lg-8 col-md-8 col-sm-7" required>
                                    </div>
                                <br>
                                    <div class="input-group mt-3">
                                        <button type="submit" class="btn btn-primary d-inline-block mx-auto">Actualizar</button>
                                    </div><br>
                                </form>
                        </div>
                    </div>
