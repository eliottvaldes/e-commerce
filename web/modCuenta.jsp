        ...
        <div class="row tm-content-row tm-mt-big">
            ...
            <div class="tm-col tm-col-big" style="width: 60%; text-align: center;">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title">Ingresa el numero de lista del usuario y el privilegio que quieres cambiar</h2>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <form action="ModificarUsuario" method="post" class="tm-login-form">
                                ...
                                <br>
                                    <div class="input-group mt-3">
                                        <label for="tipo" class="col-xl-4 col-lg-4 col-md-4 col-sm-5 col-form-label">Tipo: </label>
                                        <input name="tipo" type="text" placeholder="Cliente" class="form-control validate" id="tipo" list="listatipos" required>
